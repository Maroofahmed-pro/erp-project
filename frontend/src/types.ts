export interface Client { id:number; name:string; name_ur:string; phone:string; address:string; opening_balance:string; balance:string; credit_limit:string; is_active:boolean; notes:string; created_at?:string }
export interface InventoryItem { id:number; name:string; name_ur:string; category:string; unit:string; current_stock:string; minimum_stock:string; purchase_rate:string; is_active:boolean; created_at?:string }
