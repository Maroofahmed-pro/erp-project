...
function HistoryMetric({label,value,tone}:{label:string;value:string;tone:"green"|"blue"|"amber"|"red"}){return <div className={`history-metric history-metric-${tone} rounded-2xl border p-4`}><p className="text-[10px] font-bold uppercase tracking-wider opacity-70">{label}</p><p className="mt-2 text-xl font-extrabold tabular-nums">{value}</p></div>}
